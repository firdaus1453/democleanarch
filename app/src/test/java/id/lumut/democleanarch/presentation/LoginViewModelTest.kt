...
/**
 * Unit test untuk LoginViewModel di :app module.
 *
 * Test ini menggunakan FakeAuthRepository — cukup implement
 * interface dari :domain module, tanpa perlu :data module.
 *
 * Ini menunjukkan bahwa :app module bisa di-test
 * TANPA bergantung ke implementasi :data.
 */
