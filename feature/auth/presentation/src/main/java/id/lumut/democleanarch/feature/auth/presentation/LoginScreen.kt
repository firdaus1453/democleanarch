...
/**
 * Login Screen — di :feature:auth:presentation module.
 *
 * Composable ini HANYA ada di scope feature Auth.
 * Feature Home punya screen sendiri di :feature:home:presentation.
 *
 * Feature TIDAK BOLEH komunikasi langsung:
 * ❌ :feature:home:presentation → :feature:auth:presentation
        ...
        Box(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "Feature Layered Multi Module",
